...
const telRegex = /(84[3|5|7|8|9])+([0-9]{8})\b/
    ...
    const validate = () => {
        if(nameRef.current && emailRef.current && passRef.current && confirmPassRef.current && telRef.current) {
            ...
            if(name === ''){
                ...
                flag = false
                setNameMes('Please enter a valid name')
            }
            if(email === ''){
                flag = false
            ...
            if(tel === ''){
                flag = false
                setConfirmPassMes('Please enter your phone number')
            }else if(!telRegex.test(tel)){
                flag = false
                setConfirmPassMes('Please a valid phone number')
            }
            if(flag){
