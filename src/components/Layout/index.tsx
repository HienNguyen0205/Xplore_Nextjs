...
const nonHeaderRoute = ['/_error','/sign-in','/sign-up','/forgot-password','/change-password']
const nonFooterRoute = ['/_error','/sign-in','/sign-up','/history','/profile','/forgot-password','/change-password']
